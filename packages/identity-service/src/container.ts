...
import { PrismaAuthCredentialRepository } from "./infrastructure/adapters/out/persistence/prisma-auth-credential.repository";
import { PrismaUserRegistrationPersistence } from "./infrastructure/adapters/out/persistence/prisma-user-registration.repository";
import { PrismaUserOAuthRegistrationPersistence } from "./infrastructure/adapters/out/persistence/prisma-user-oauth-registration.repository";
import { PrismaOAuthAccountRepository } from "./infrastructure/adapters/out/persistence/prisma-oauth-account.repository";
import { RabbitMqEventPublisherAdapter } from "./infrastructure/adapters/out/messaging/rabbitmq-event-publisher.adapter";
import { UserCreatedNotifierAdapter } from "./infrastructure/adapters/out/notifiers/user-created-notifier.adapter";
import { JwtTokenService } from "./infrastructure/adapters/out/auth/jwt-token.service";
...
import { createUserRoutes } from "./infrastructure/adapters/in/http/routes";
import { createAuthRoutes } from "./infrastructure/adapters/in/http/auth.routes";
