...
import { PrismaUserRegistrationPersistence } from "./infrastructure/persistence/prisma-user-registration.persistence";
import { PrismaUserOAuthRegistrationPersistence } from "./infrastructure/persistence/prisma-user-oauth-registration.persistence";
